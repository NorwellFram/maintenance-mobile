...
public class MeteoDAO extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATION_TABLE_2 = "create table meteo(id INTEGER PRIMARY KEY, ville TEXT, soleilOuNuage TEXT, date TEXT, vent TEXT, umidite Integer)";
        String SQL_CREATION_TABLE_3 = "create table meteo(id INTEGER PRIMARY KEY, ville TEXT, soleilOuNuage TEXT, date TEXT, vent TEXT, umidite Integer, temperature REAL)";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        String SQL_MISEAJOUR_TABLE_1V2 = "alter table meteo add column vent TEXT";
        String SQL_MISEAJOUR_TABLE_1V2_B = "alter table meteo add column humidite Integer";
        String SQL_MISEAJOUR_TABLE_2V3 = "alter table meteo add column temperature REAL";
        if(oldVersion==1){
            db.execSQL(SQL_MISEAJOUR_TABLE_1V2);
            db.execSQL(SQL_MISEAJOUR_TABLE_1V2_B);
        }
        if(newVersion==3){
            db.execSQL(SQL_MISEAJOUR_TABLE_2V3);
        }
